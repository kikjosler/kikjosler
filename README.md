...
<h3>Я инженер-тестировщик с опытом в ручном тестировании, работал в edtech и e-commerce компаниях. В данный момент изучаю автоматизацию тестирования на Python+Playwright.</h3>
